...
### These releases drop support for .net 5 (no longer supported by Microsoft) and add support for .net 6.  


### For the .Net standard 2.0 versions of the libraries I updated the version of NewtonSoft.Json to 13.0.1 to address a security issue
...
[JamesNK/Newtonsoft.Json#2462](https://github.com/JamesNK/Newtonsoft.Json/issues/2462)  
